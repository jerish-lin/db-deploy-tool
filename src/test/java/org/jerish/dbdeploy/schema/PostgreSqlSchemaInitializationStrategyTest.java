...
@DisplayName("Unit tests for PostgreSqlSchemaInitializationStrategy")
public class PostgreSqlSchemaInitializationStrategyTest {

    @Mock
    private JdbcTemplate jdbcTemplate;

    private PostgreSqlSchemaInitializationStrategy strategy;
    ...
    void testGetSchemaFilesBasePath() {
        assertEquals("db-deploy/schema/postgresql", strategy.getSchemaFilesBasePath());
    }
    ...
    @Test
    @DisplayName("Test isSchemaInitialized uses PostgreSQL-specific query")
    void testIsSchemaInitialized_UsesPostgreSQLQuery() {
        when(jdbcTemplate.queryForObject(anyString(), eq(Integer.class)))
                .thenReturn(1);
    ...
    @Test
    @DisplayName("Test strategy is correctly typed as PostgreSQL")
    void testStrategyType() {
        ...
        assertTrue(strategy instanceof PostgreSqlSchemaInitializationStrategy);
    }
