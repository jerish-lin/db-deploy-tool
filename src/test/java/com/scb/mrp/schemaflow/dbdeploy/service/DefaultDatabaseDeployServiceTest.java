...
//import org.jerish.dbdeploy.entity.ScriptFile;
...
//        changeLogConfig.setBasePath("src/test/resources");
//        changeLogConfig.setFileName("test-changelog.yml");
//
//        ScriptConfig scriptConfig = new ScriptConfig("test-script", null);
//        changeLogConfig.setScripts(List.of(scriptConfig));
//
//        // Setup script file
//        scriptFile = mock(ScriptFile.class);
